...
class Howto extends React.Component{
    render(){
        return(
            <>
                <p>Select the dimensions of the game board you want to play on.</p>
                <p>Then the game is tic-tac-toe. You want to set pieces that will link -</p>
                <p>from one end of the grid to the other end.</p>
